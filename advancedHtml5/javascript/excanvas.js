function showCanvas(){
	...
	if(canvas.getContext){
		...
		ctx.arc(40, 120, 30, 0, 3.14, true);
		ctx.stroke();
		
		ctx.beginPath();
		ctx.arc(90, 120, 10, 0, 3.14, false);
		ctx.stroke();
		...
		ctx.beginPath();
		ctx.moveTo(80, 80);
		ctx.quadraticCurveTo(200, 220, 150, 50);
		ctx.stroke();
		...
		ctx.beginPath();
		ctx.moveTo(250, 80);
		ctx.bezierCurveTo(200, 150, 180, 80, 120, 100);
		ctx.stroke();
